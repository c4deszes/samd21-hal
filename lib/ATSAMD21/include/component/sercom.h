...
#define   SERCOM_SPI_CTRLA_MODE_USART_EXT_CLK_Val _UINT32_(0x0)                                        /* (SERCOM_SPI_CTRLA) USART with external clock  */
#define   SERCOM_SPI_CTRLA_MODE_USART_INT_CLK_Val _UINT32_(0x1)                                        /* (SERCOM_SPI_CTRLA) USART with internal clock  */
#define   SERCOM_SPI_CTRLA_MODE_SPI_SLAVE_Val _UINT32_(0x2)                                        /* (SERCOM_SPI_CTRLA) SPI in slave operation  */
#define   SERCOM_SPI_CTRLA_MODE_SPI_MASTER_Val _UINT32_(0x3)                                        /* (SERCOM_SPI_CTRLA) SPI in master operation  */
#define   SERCOM_SPI_CTRLA_MODE_I2C_SLAVE_Val _UINT32_(0x4)                                        /* (SERCOM_SPI_CTRLA) I2C slave operation  */
#define   SERCOM_SPI_CTRLA_MODE_I2C_MASTER_Val _UINT32_(0x5)                                        /* (SERCOM_SPI_CTRLA) I2C master operation  */
#define SERCOM_SPI_CTRLA_MODE_USART_EXT_CLK  (SERCOM_SPI_CTRLA_MODE_USART_EXT_CLK_Val << SERCOM_SPI_CTRLA_MODE_Pos) /* (SERCOM_SPI_CTRLA) USART with external clock Position */
#define SERCOM_SPI_CTRLA_MODE_USART_INT_CLK  (SERCOM_SPI_CTRLA_MODE_USART_INT_CLK_Val << SERCOM_SPI_CTRLA_MODE_Pos) /* (SERCOM_SPI_CTRLA) USART with internal clock Position */
#define SERCOM_SPI_CTRLA_MODE_SPI_SLAVE      (SERCOM_SPI_CTRLA_MODE_SPI_SLAVE_Val << SERCOM_SPI_CTRLA_MODE_Pos) /* (SERCOM_SPI_CTRLA) SPI in slave operation Position */
#define SERCOM_SPI_CTRLA_MODE_SPI_MASTER     (SERCOM_SPI_CTRLA_MODE_SPI_MASTER_Val << SERCOM_SPI_CTRLA_MODE_Pos) /* (SERCOM_SPI_CTRLA) SPI in master operation Position */
#define SERCOM_SPI_CTRLA_MODE_I2C_SLAVE      (SERCOM_SPI_CTRLA_MODE_I2C_SLAVE_Val << SERCOM_SPI_CTRLA_MODE_Pos) /* (SERCOM_SPI_CTRLA) I2C slave operation Position */
#define SERCOM_SPI_CTRLA_MODE_I2C_MASTER     (SERCOM_SPI_CTRLA_MODE_I2C_MASTER_Val << SERCOM_SPI_CTRLA_MODE_Pos) /* (SERCOM_SPI_CTRLA) I2C master operation Position */
...
#define   SERCOM_SPI_CTRLA_DOPO_PAD1_Val     _UINT32_(0x1)                                        /* (SERCOM_SPI_CTRLA) DO on PAD[2], SCK on PAD[3] and SS on PAD[1]  */
#define   SERCOM_SPI_CTRLA_DOPO_PAD2_Val     _UINT32_(0x2)                                        /* (SERCOM_SPI_CTRLA) DO on PAD[3], SCK on PAD[1] and SS on PAD[2]  */
#define   SERCOM_SPI_CTRLA_DOPO_PAD3_Val     _UINT32_(0x3)                                        /* (SERCOM_SPI_CTRLA) DO on PAD[0], SCK on PAD[3] and SS on PAD[1]  */
...
#define SERCOM_SPI_CTRLA_DOPO_PAD1           (SERCOM_SPI_CTRLA_DOPO_PAD1_Val << SERCOM_SPI_CTRLA_DOPO_Pos) /* (SERCOM_SPI_CTRLA) DO on PAD[2], SCK on PAD[3] and SS on PAD[1] Position */
#define SERCOM_SPI_CTRLA_DOPO_PAD2           (SERCOM_SPI_CTRLA_DOPO_PAD2_Val << SERCOM_SPI_CTRLA_DOPO_Pos) /* (SERCOM_SPI_CTRLA) DO on PAD[3], SCK on PAD[1] and SS on PAD[2] Position */
#define SERCOM_SPI_CTRLA_DOPO_PAD3           (SERCOM_SPI_CTRLA_DOPO_PAD3_Val << SERCOM_SPI_CTRLA_DOPO_Pos) /* (SERCOM_SPI_CTRLA) DO on PAD[0], SCK on PAD[3] and SS on PAD[1] Position */
...
#define   SERCOM_SPI_CTRLA_DIPO_PAD0_Val     _UINT32_(0x0)                                        /* (SERCOM_SPI_CTRLA) SERCOM PAD[0]  */
#define   SERCOM_SPI_CTRLA_DIPO_PAD1_Val     _UINT32_(0x1)                                        /* (SERCOM_SPI_CTRLA) SERCOM PAD[1]  */
#define   SERCOM_SPI_CTRLA_DIPO_PAD2_Val     _UINT32_(0x2)                                        /* (SERCOM_SPI_CTRLA) SERCOM PAD[2]  */
#define   SERCOM_SPI_CTRLA_DIPO_PAD3_Val     _UINT32_(0x3)                                        /* (SERCOM_SPI_CTRLA) SERCOM PAD[3]  */
#define SERCOM_SPI_CTRLA_DIPO_PAD0           (SERCOM_SPI_CTRLA_DIPO_PAD0_Val << SERCOM_SPI_CTRLA_DIPO_Pos) /* (SERCOM_SPI_CTRLA) SERCOM PAD[0] Position */
#define SERCOM_SPI_CTRLA_DIPO_PAD1           (SERCOM_SPI_CTRLA_DIPO_PAD1_Val << SERCOM_SPI_CTRLA_DIPO_Pos) /* (SERCOM_SPI_CTRLA) SERCOM PAD[1] Position */
#define SERCOM_SPI_CTRLA_DIPO_PAD2           (SERCOM_SPI_CTRLA_DIPO_PAD2_Val << SERCOM_SPI_CTRLA_DIPO_Pos) /* (SERCOM_SPI_CTRLA) SERCOM PAD[2] Position */
#define SERCOM_SPI_CTRLA_DIPO_PAD3           (SERCOM_SPI_CTRLA_DIPO_PAD3_Val << SERCOM_SPI_CTRLA_DIPO_Pos) /* (SERCOM_SPI_CTRLA) SERCOM PAD[3] Position */
...
#define   SERCOM_SPI_CTRLA_FORM_SPI_FRAME_WITH_ADDR_Val _UINT32_(0x2)                                        /* (SERCOM_SPI_CTRLA) SPI Frame with Addr  */
...
#define SERCOM_SPI_CTRLA_FORM_SPI_FRAME_WITH_ADDR (SERCOM_SPI_CTRLA_FORM_SPI_FRAME_WITH_ADDR_Val << SERCOM_SPI_CTRLA_FORM_Pos) /* (SERCOM_SPI_CTRLA) SPI Frame with Addr Position */
...
#define   SERCOM_SPI_CTRLA_CPOL_IDLE_LOW_Val _UINT32_(0x0)                                        /* (SERCOM_SPI_CTRLA) SCK is low when idle  */
#define   SERCOM_SPI_CTRLA_CPOL_IDLE_HIGH_Val _UINT32_(0x1)                                        /* (SERCOM_SPI_CTRLA) SCK is high when idle  */
#define SERCOM_SPI_CTRLA_CPOL_IDLE_LOW       (SERCOM_SPI_CTRLA_CPOL_IDLE_LOW_Val << SERCOM_SPI_CTRLA_CPOL_Pos) /* (SERCOM_SPI_CTRLA) SCK is low when idle Position */
#define SERCOM_SPI_CTRLA_CPOL_IDLE_HIGH      (SERCOM_SPI_CTRLA_CPOL_IDLE_HIGH_Val << SERCOM_SPI_CTRLA_CPOL_Pos) /* (SERCOM_SPI_CTRLA) SCK is high when idle Position */
...
#define   SERCOM_USART_CTRLA_MODE_USART_CLK_Val _UINT32_(0x0)                                        /* (SERCOM_USART_CTRLA) USART with external clock  */
#define   SERCOM_USART_CTRLA_MODE_USART_INT_CLK_Val _UINT32_(0x1)                                        /* (SERCOM_USART_CTRLA) USART with internal clock  */
#define   SERCOM_USART_CTRLA_MODE_SPI_SLAVE_Val _UINT32_(0x2)                                        /* (SERCOM_USART_CTRLA) SPI in slave operation  */
#define   SERCOM_USART_CTRLA_MODE_SPI_MASTER_Val _UINT32_(0x3)                                        /* (SERCOM_USART_CTRLA) SPI in master operation  */
#define   SERCOM_USART_CTRLA_MODE_I2C_SLAVE_Val _UINT32_(0x4)                                        /* (SERCOM_USART_CTRLA) I2C slave operation  */
#define   SERCOM_USART_CTRLA_MODE_I2C_MASTER_Val _UINT32_(0x5)                                        /* (SERCOM_USART_CTRLA) I2C master operation  */
#define SERCOM_USART_CTRLA_MODE_USART_CLK (SERCOM_USART_CTRLA_MODE_USART_CLK_Val << SERCOM_USART_CTRLA_MODE_Pos) /* (SERCOM_USART_CTRLA) USART with external clock Position */
#define SERCOM_USART_CTRLA_MODE_USART_INT_CLK (SERCOM_USART_CTRLA_MODE_USART_INT_CLK_Val << SERCOM_USART_CTRLA_MODE_Pos) /* (SERCOM_USART_CTRLA) USART with internal clock Position */
#define SERCOM_USART_CTRLA_MODE_SPI_SLAVE (SERCOM_USART_CTRLA_MODE_SPI_SLAVE_Val << SERCOM_USART_CTRLA_MODE_Pos) /* (SERCOM_USART_CTRLA) SPI in slave operation Position */
#define SERCOM_USART_CTRLA_MODE_SPI_MASTER (SERCOM_USART_CTRLA_MODE_SPI_MASTER_Val << SERCOM_USART_CTRLA_MODE_Pos) /* (SERCOM_USART_CTRLA) SPI in master operation Position */
#define SERCOM_USART_CTRLA_MODE_I2C_SLAVE (SERCOM_USART_CTRLA_MODE_I2C_SLAVE_Val << SERCOM_USART_CTRLA_MODE_Pos) /* (SERCOM_USART_CTRLA) I2C slave operation Position */
#define SERCOM_USART_CTRLA_MODE_I2C_MASTER (SERCOM_USART_CTRLA_MODE_I2C_MASTER_Val << SERCOM_USART_CTRLA_MODE_Pos) /* (SERCOM_USART_CTRLA) I2C master operation Position */
...
#define   SERCOM_USART_CTRLA_FORM_USART_FRAME_AUTO_BAUD_NO_PARITY_Val _UINT32_(0x4)                                        /* (SERCOM_USART_CTRLA) Auto-baud - break detection and auto-baud  */
...
#define SERCOM_USART_CTRLA_FORM_USART_FRAME_AUTO_BAUD_NO_PARITY (SERCOM_USART_CTRLA_FORM_USART_FRAME_AUTO_BAUD_NO_PARITY_Val << SERCOM_USART_CTRLA_FORM_Pos) /* (SERCOM_USART_CTRLA) Auto-baud - break detection and auto-baud Position */
...
#define   SERCOM_SPI_CTRLB_AMODE_MASK_Val    _UINT32_(0x0)                                        /* (SERCOM_SPI_CTRLB) SPI Address mask   */
#define   SERCOM_SPI_CTRLB_AMODE_2_ADDRESSES_Val _UINT32_(0x1)                                        /* (SERCOM_SPI_CTRLB) Two unique Addressess  */
#define   SERCOM_SPI_CTRLB_AMODE_RANGE_Val   _UINT32_(0x2)                                        /* (SERCOM_SPI_CTRLB) Address Range  */
#define SERCOM_SPI_CTRLB_AMODE_MASK          (SERCOM_SPI_CTRLB_AMODE_MASK_Val << SERCOM_SPI_CTRLB_AMODE_Pos) /* (SERCOM_SPI_CTRLB) SPI Address mask  Position */
#define SERCOM_SPI_CTRLB_AMODE_2_ADDRESSES   (SERCOM_SPI_CTRLB_AMODE_2_ADDRESSES_Val << SERCOM_SPI_CTRLB_AMODE_Pos) /* (SERCOM_SPI_CTRLB) Two unique Addressess Position */
#define SERCOM_SPI_CTRLB_AMODE_RANGE         (SERCOM_SPI_CTRLB_AMODE_RANGE_Val << SERCOM_SPI_CTRLB_AMODE_Pos) /* (SERCOM_SPI_CTRLB) Address Range Position */
...
#define   SERCOM_USART_CTRLB_CHSIZE_8_BIT_Val _UINT32_(0x0)                                        /* (SERCOM_USART_CTRLB) 8 Bits  */
#define   SERCOM_USART_CTRLB_CHSIZE_9_BIT_Val _UINT32_(0x1)                                        /* (SERCOM_USART_CTRLB) 9 Bits  */
#define   SERCOM_USART_CTRLB_CHSIZE_5_BIT_Val _UINT32_(0x5)                                        /* (SERCOM_USART_CTRLB) 5 Bits  */
#define   SERCOM_USART_CTRLB_CHSIZE_6_BIT_Val _UINT32_(0x6)                                        /* (SERCOM_USART_CTRLB) 6 Bits  */
#define   SERCOM_USART_CTRLB_CHSIZE_7_BIT_Val _UINT32_(0x7)                                        /* (SERCOM_USART_CTRLB) 7 Bits  */
#define SERCOM_USART_CTRLB_CHSIZE_8_BIT   (SERCOM_USART_CTRLB_CHSIZE_8_BIT_Val << SERCOM_USART_CTRLB_CHSIZE_Pos) /* (SERCOM_USART_CTRLB) 8 Bits Position */
#define SERCOM_USART_CTRLB_CHSIZE_9_BIT   (SERCOM_USART_CTRLB_CHSIZE_9_BIT_Val << SERCOM_USART_CTRLB_CHSIZE_Pos) /* (SERCOM_USART_CTRLB) 9 Bits Position */
#define SERCOM_USART_CTRLB_CHSIZE_5_BIT   (SERCOM_USART_CTRLB_CHSIZE_5_BIT_Val << SERCOM_USART_CTRLB_CHSIZE_Pos) /* (SERCOM_USART_CTRLB) 5 Bits Position */
#define SERCOM_USART_CTRLB_CHSIZE_6_BIT   (SERCOM_USART_CTRLB_CHSIZE_6_BIT_Val << SERCOM_USART_CTRLB_CHSIZE_Pos) /* (SERCOM_USART_CTRLB) 6 Bits Position */
#define SERCOM_USART_CTRLB_CHSIZE_7_BIT   (SERCOM_USART_CTRLB_CHSIZE_7_BIT_Val << SERCOM_USART_CTRLB_CHSIZE_Pos) /* (SERCOM_USART_CTRLB) 7 Bits Position */
